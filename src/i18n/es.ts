export default {
    ...
    members: [
      {
        ...
        description:
          'Product Manager, Senior Developer, especialista en IA, DevOps y amante del fútbol.',
        skills: ['Product Management', 'IA', 'DevOps', 'Software'],
      },
      {
        name: 'Angel Gil',
  ...
  footer: {
    rights: '© 2026 AMR Consulting. Todos los derechos reservados.',
